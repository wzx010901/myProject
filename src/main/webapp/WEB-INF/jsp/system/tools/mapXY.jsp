...
<table bgcolor="#E3E4D8" width="100%">
	<tr>
		<td>纬度：</td>
		<td><input id="coordinateX" value="" type="text" /></td>
		<td>经度：</td>
		<td><input id="coordinateY" value="" type="text" /></td>
...
<div id="allmap"></div>
	...
	map.enableContinuousZoom();    //启用地图惯性拖拽，默认禁用
		...
		function showInfo(e){
		 	...
		 	document.getElementById("coordinateX").value = e.point.lat;
		    document.getElementById("coordinateY").value = e.point.lng;
