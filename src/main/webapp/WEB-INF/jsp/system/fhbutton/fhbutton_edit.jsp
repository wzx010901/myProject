			...
			<div class="page-content">
				<div class="row">
					...
					<form action="fhbutton/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="fhbuttonId" id="fhbuttonId" value="${pd.fhbuttonId}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input oninput="changecode(this.value)" type="text" name="jurisdictionName" id="jurisdictionName" value="${pd.jurisdictionName}" maxlength="50" placeholder="这里输入权限标识" title="权限标识" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$(top.hangge());
		$(function() {
			var str1 = '<c'+':if test="'+'$'+'{jurisdiction.'+$("#jurisdictionName").val();
			var str2 = ' == 1 }">这里放按钮<'+'/c:'+'if>';
			$("#code").val(str1+str2);
		});
		//拼代码
		function changecode(value){
			var str1 = '<c'+':if test="'+'$'+'{jurisdiction.';
			var str2 = ' == 1 }">这里放按钮<'+'/c:'+'if>';
		...
		function save(){
			...
			if($("#jurisdictionName").val()==""){
				$("#jurisdictionName").tips({
					side:3,
		            msg:'请输入权限标识',
		            bg:'#AE81FF',
		            time:2
