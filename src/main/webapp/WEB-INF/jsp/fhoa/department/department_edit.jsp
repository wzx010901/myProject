			...
			<div class="page-content">
				<div class="row">
					...
					<form action="department/${msg }.do" name="Form" id="Form" method="post">
						...
						<input type="hidden" name="parentId" id="parentId" value="${null == pd.parentId ? departmentId:pd.parentId}"/>
						<div id="zhongxin">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="encoding" id="encoding" value="${pd.encoding}" maxlength="32" placeholder="这里输入编码 (不重复, 禁止修改)" title="编码" style="width:76%;" onblur="hasEncoding();" <c:if test="${null != pd.encoding}">readonly="readonly"</c:if>/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function hasEncoding(){
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>department/hasEncoding.do',
