...
<script type="text/javascript">
	...
	function hasK(){
		...
		var textmsgId = "${pd.textmsgId}";
		$.ajax({
			type: "POST",
			url: '<%=basePath%>textmsg/hasK.do',
	    	data: {keyword:keyword,textmsgId:textmsgId,tm:new Date().getTime()},
			dataType:'json',
			cache: false,
				...
				<div class="row">
					<div class="col-xs-12">
								<form action="textmsg/${msg }.do" name="Form" id="Form" method="post">
									<input type="hidden" name="textmsgId" id="textmsgId" value="${pd.textmsgId}"/>
