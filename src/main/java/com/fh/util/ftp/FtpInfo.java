...
public class FtpInfo {
	...
	public FtpInfo(String hostName, int port, String username, String password, String encoding) {
	...
	public FtpInfo(String hostName, int port, String username, String password, String remoteDir, String localDir,
