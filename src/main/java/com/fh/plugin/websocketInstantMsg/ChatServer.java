...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq149156999")){
			this.userjoin(message.replaceFirst("FHadminqq149156999", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqq149156999")){
			this.userLeave(conn);
