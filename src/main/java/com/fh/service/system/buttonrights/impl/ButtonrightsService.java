...
public class ButtonrightsService implements ButtonrightsManager{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<PageData> listAllBrAndJurisdictionName(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("ButtonrightsMapper.listAllBrAndJurisdictionName", pd);
	}
