...
public class DepartmentService implements DepartmentManager{
	 ...
	 * @throws Exception
	 */
	public PageData findByEncoding(PageData pd)throws Exception{
		return (PageData)dao.findForObject("DepartmentMapper.findByEncoding", pd);
	}
	...
	public List<Department> listAllDepartment(String parentId) throws Exception {
		...
		for(Department depar : departmentList){
			depar.setTreeUrl("department/list.do?departmentId="+depar.getDepartmentId());
			depar.setSubDepartment(this.listAllDepartment(depar.getDepartmentId()));
