...
-- ----------------------------
-- Table structure for `${tabletop}${objectNameOriginal}`
-- ----------------------------
DROP TABLE IF EXISTS `${tabletop}${objectNameOriginal}`;
CREATE TABLE `${tabletop}${objectNameOriginal}` (
 		`${objectNameOriginal}_id` varchar(100) NOT NULL,
	...
	<#list fieldList as var>
		...
		`${var[0]}` varchar(${var[5]}) DEFAULT NULL COMMENT '${var[2]}',
  		...
  		PRIMARY KEY (`${objectNameOriginal}_ID`)
